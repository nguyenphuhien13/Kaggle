...
# Reading data
train <- read.csv("train.csv", stringsAsFactors = F, sep=',')
test <- read.csv("test.csv", stringsAsFactors = F, sep=',')
...
write.csv(solution,"C:/Users/nguyen phu hien/kaggle/FDS-project/svm_solution_32.csv",row.names = F)
